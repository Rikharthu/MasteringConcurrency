package com.example.uberv.threads.com.example.uberv.utils;
...
public abstract class Logger {
    ...
    private static void tryLogMessage(LogLevel logLevel, String message, @Nullable Object... args) {
        tryLogMessage(System.out, logLevel, message, args);
    }

    private static void tryLogMessage(PrintStream printStream, LogLevel logLevel, String message, @Nullable Object... args) {
